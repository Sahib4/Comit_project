                        ...
                        <li>
                            <div className = "card card-body">
                                ...
                                <p>
                                    ...
                                    <strong>Address:</strong> {cart.shippingAddress.address},{cart.shippingAddress.address},{cart.shippingAddress.city},{cart.shippingAddress.postalcode},{cart.shippingAddress.country}
                                </p>
                            </div>
                        </li>
                        <li>
